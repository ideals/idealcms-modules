...
use Shop\Structure\Service\Load1CV208\Log\Log;
use Shop\Structure\Service\Load1CV208\Models\OrderModel;
...
class FrontController
{
    ...
    /** @var \Shop\Structure\Service\Load1CV208\Log\Log Класс для логирования процесса обмена данными */
    protected $logClass;
...
LOGMESSAGE;
    ...
    protected function getModel($filename)
    {
        ...
        $model = 'Shop\\Structure\\Service\\Load1CV208\\Models\\' . ucfirst($type[1]) . 'Model';
