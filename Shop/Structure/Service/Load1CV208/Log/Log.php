<?php
namespace Shop\Structure\Service\Load1CV208\Log;
...
class Log
{
    ...
    public function __construct()
    {
        ...
        $successLogFilePath .= 'log1CV3Success.log';

        // Если файла логирования ещё нет, то создаём его
        if (!file_exists($successLogFilePath) && !touch($successLogFilePath)) {
            throw new \RuntimeException('Не удалось создать файл для хранения хранения логов успешной выгрузки');
        }
