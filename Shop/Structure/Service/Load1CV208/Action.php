...
<form action="" method=post enctype="multipart/form-data">
    ...
    if (!file_exists($settingsFilePath)) {
        $settingsFilePathMod = $cmsFolderPath . 'Mods/Shop/Structure/Service/Load1CV208/Load1CV208Settings.php';
...
<script type="text/javascript">
    ...
    function startPprocess(file, onlyImageResize) {
        ...
        url += '&action=getFile&controller=Shop\\Structure\\Service\\Load1CV208&mode=ajax&file=' + file +
    ...
    function import1c(file, workDir, onlyImageResize) {
        ...
        var url = window.location.href;
        url += '&action=importFile&controller=Shop\\Structure\\Service\\Load1CV208&mode=ajax&file=' + file;
        $.ajax({
            url: url,
            type: 'POST',
            data: {
