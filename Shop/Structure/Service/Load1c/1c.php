    ...
    public function get($text)
    {
        switch ($_GET[$text]) {
            ...
            case 'file':
                ...
                $dir = $filename === 'import.xml' || $filename === 'offers.xml' ? '' : str_replace('/' . $filename, '', $_GET['filename']);
...
$tmp = $tool->get('mode');
if ($tmp) {
    $i = new Image($tmp, 150, 150, 'big', false);
}
