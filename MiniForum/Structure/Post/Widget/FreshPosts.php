...
class FreshPosts extends Widget
{
    public function getData()
    {
        ...
        $_sql = "
          ...
          LIMIT 3";
        $params = ['is_active' => '1', 'main_parent_id' => '0'];
        $fields = ['table' => $config->db['prefix'] . 'miniforum_structure_post'];
        ...
        foreach ($posts as $key => $value) {
            ...
            $posts[$key]['content'] = $content !== '' ? mb_substr($value['content'], 0, 30) . $content : $value['content'];
